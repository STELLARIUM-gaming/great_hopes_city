...
if (sprite_index=asset_get_index("spr_"+sprit+"_lavka_"+lav_num +"_a") and scr_dim_animation_end(sprite_index) )
{
	...
	switch (lav_num){
	case 1:activities=ACTIVITIES_GG.LAVKA1	break;
	case 2:activities=ACTIVITIES_GG.LAVKA2	break;
	case 3:activities=ACTIVITIES_GG.LAVKA3	break;
	case 4:activities=ACTIVITIES_GG.LAVKA4	break;
	}
